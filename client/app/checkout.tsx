  ...
  return (
    <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
      ...
      <ScrollView className='flex-1 px-4 mt-4'>
        ...
        <TouchableOpacity onPress={() => setPaymentMethod('cash')} className={`bg-white p-4 rounded-xl mb-4 shadow-sm flex-row items-center border-2 ${payementMethod === 'cash' ? 'border-primary' : 'border-transparent'}`}>
          ...
          {payementMethod === 'cash' && <Ionicons name='checkmark-circle' size={24} color={COLORS.primary} />}
        </TouchableOpacity>

        {/* Stripe Option */}
        <TouchableOpacity onPress={() => setPaymentMethod('stripe')} className={`bg-white p-4 rounded-xl mb-4 shadow-sm flex-row items-center border-2 ${payementMethod === 'stripe' ? 'border-primary' : 'border-transparent'}`}>
          ...
          {payementMethod === 'stripe' && <Ionicons name='checkmark-circle' size={24} color={COLORS.primary} />}
        </TouchableOpacity>
      </ScrollView>
